...
def start():
    ...
    pidz = PID(0.2, 0.0, 0.0001, setpoint=0.170)
    ...
    weights = 'C:/Users/Prajwal/Python_Projects/Masters_Thesis/YOLO-V5/thesis.pt'
    ...
    while True:
        ...
        if (319 <= position[0] <= 321) and (239.5 <= position[1] <= 240.5) or (0.165 <= round(position[2], 3) <= 0.175):
            ...
            rtde_c.moveL([0.334, -0.52579, 0.0685, 0.032, -3.154, -0.017],0.15,0.15)
            gripper.open()
            rtde_c.moveL([0.334, -0.52579, 0.2, 0.032, -3.154, -0.017],0.15,0.15)
            rtde_c.disconnect()
            rtde_r.disconnect()
            break
